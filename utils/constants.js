...
module.exports = {
    ...
    // File Paths
    SOUND_COUNTS_PATH: configuredPath('SOUND_COUNTS_PATH', path.join(__dirname, '../config/soundCounts.json')),
    SOUND_LOGS_PATH: configuredPath('SOUND_LOGS_PATH', path.join(__dirname, '../config/sound_logs.txt')),
